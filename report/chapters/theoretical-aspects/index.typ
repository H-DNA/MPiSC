...
Linearizability is a criteria for evaluating a concurrent algorithm's correctness. This is the model we use to prove our algorithm's correctness.
...
The harder case is handled via the notion of *linearizability*.
