...
#align(center)[
  ...
  $\{(i s F u l l (q, t) arrow q' = q) and (not i s F u l l(q, t) arrow q' = i n s(q, (e, t)))\}$
]
- Axiom $D M$:
#align(center)[
  $\{t r u e\}$
  ...
  $\{(i s E m p(q) arrow q' = q) and (not i s E m p(q) arrow q' = r e s t(q)) and e = f i r s t(q).0\}$
]

- #text[Trait for MPSC queue values:
    ...
    *introduces*
    #align(center)[
      ...
      $i n s: Q, E times$ *Int* $arrow Q$

      $f i r s t: Q arrow E times$ *Int* $union \{$(*nil*, *nil*)$\}$

      $r e s t: Q arrow Q$

      $i s E m p: Q arrow$ *Bool*

      $l e n: Q,$ *Int* $arrow$ *Int*

      $i s F u l l: Q,$ *Int* $arrow$ *Bool*
    ]
    *constrains* $Q$ *so that*
    $Q$ *generated by* $[ e m p, i n s]$

    *for all* $q:Q, t: E times$ *Int*$, n:$ *Int*
    #align(center)[
      $f i r s t(e m p)=$ *(nil, nil)*

      $f i r s t(i n s (q, t))=$ *if* $i s E m p(q)$ *then* $t$ *else* $f i r s t(q)$

      $r e s t(e m p) = e m p$

      $r e s t(i n s(q, t)) =$ *if* $i s E m p(q)$ *then* $e m p$ *else* $i n s(r e s t(q), e)$

      $i s E m p(e m p) =$ *true*

      $i s E m p(i n s(q, t)) =$ *false*

      $l e n (e m p, n) = 0$

      $l e n (i n s(q, t), n) =$ *if* $t.1 = n$ *then* $l e n(q, n) + 1$ *else* $l e n(q, n)$

      $i s F u l l (q, n) = (l e n (q, n) = C a p a c i t y)$
    ]]

=== Linearizability Verification <linearizability-verification>

Our verification technique for linearizability is based on @axiomatic-spec. In this section, we present a technique to show that an implementation is correct.
