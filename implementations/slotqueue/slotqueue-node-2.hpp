...
#include "../lib/spsc/bounded_spsc_2.hpp"
#include <cstdint>
#include <cstdio>
#include <cstdlib>
#include <mpi.h>
...
public:
  SlotNodeQueue_2(MPI_Aint capacity_per_node, MPI_Aint dequeuer_rank,
                  MPI_Comm comm)
  ...
  SlotNodeQueue_2(const SlotNodeQueue_2 &) = delete;
  SlotNodeQueue_2 &operator=(const SlotNodeQueue_2 &) = delete;

  SlotNodeQueue_2(SlotNodeQueue_2 &&other) noexcept
